...
function ENT:CustomOnInitialize()
	...
	spawnglow:SetKeyValue("scale", "1.35")
	...
	bombglow:SetKeyValue("scale", "0.55")
	...
	self.Light1:Fire("Color", "0 144 255")
	...
	self.Light1 = ents.Create("light_dynamic")
	self.Light1:SetKeyValue("brightness", "5")
	self.Light1:SetKeyValue("distance", "125")
	self.Light1:SetLocalPos(self:GetPos() + self:GetUp()*0 + self:GetForward()*0)
	self.Light1:SetLocalAngles(self:GetAngles())
	self.Light1:Fire("Color", "198 230 255")
	self.Light1:SetParent(self)
	self.Light1:Spawn()
	self.Light1:Activate()
	self.Light1:Fire("TurnOn", "", 0)
...
function ENT:CustomOnThink()
	...
	util.VJ_SphereDamage(self, self, self:GetPos(), 150, 1, DMG_DISSOLVE, true, true)
...
function ENT:CustomOnRemove()
	...
	util.VJ_SphereDamage(self, self, self:GetPos(), 50, 100, DMG_DISSOLVE, true, true)
