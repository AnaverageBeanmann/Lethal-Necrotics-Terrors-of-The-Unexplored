...
ENT.SoundTbl_Startup = {"vj_acid/acid_blood.wav"}
ENT.SoundTbl_Idle = {
		"vj_acid/acid_idle1.wav"
	}
ENT.SoundTbl_OnCollide = {
		"vj_acid/acid_impact.wav"
	}
ENT.SoundTbl_OnRemove = {"vj_acid/acid_splat.wav"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomOnRemove()
	local carproj = ents.Create("obj_vj_totu_acidbomb_puddle")
